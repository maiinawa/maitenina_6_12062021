...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nvar datas = __webpack_require__(/*! ./data/data.json */ \"./src/data/data.json\");\n\nvar HomeScreen = {\n  render: function render() {\n    var photographers = datas.photographers;\n    return photographers.map(function (item) {\n      return \"<article class=\\\"photographer__card\\\">\\n                <a href=\\\"./src/pages/profilepage.html\\\">\\n                <div class=\\\"photographer__id\\\">\\n                    <img src=\\\"/src/medias/Photographers_ID_Photos/\".concat(item.portrait, \"\\\">\\n                    <h2>\").concat(item.name, \"</h2>\\n                </div>\\n                <div class=\\\"photographer__detail\\\">\\n                    <h3>\").concat(item.city, \", \").concat(item.country, \"</h3>\\n                    <p>\").concat(item.tagline, \"</p>\\n                    <p>\").concat(item.price, \"\\u20AC/jour</p>\\n                </div>\\n                </a>\\n                <div class=\\\"photographer__tags container__tags\\\">\\n                    \").concat(tags(item.tags), \"\\n                </div>\\n            </article>\");\n    }).join('');\n  }\n};\n\nvar tags = function tags(_tags) {\n  return \"\".concat(_tags.map(function (item) {\n    return \"<a class=\\\"tags\\\" href=\\\"index.html\\\"><span>\".concat(item, \"</span></a>\");\n  }).join(''));\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (HomeScreen);\n\n//# sourceURL=webpack://test-webpack/./src/homeScreen.js?");
