...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getParamValue);
...
const ProfileScreen = {
    render : () => {
        const {photographers} = datas;
        const theID = (0,_params__WEBPACK_IMPORTED_MODULE_0__.default)('user')
        ...
        //mosaic gallery
        _mediasRendeeer__WEBPACK_IMPORTED_MODULE_1__.default.render(galleryWanted)
        //profile render
...
/* harmony import */ var _likeCount__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./likeCount */ "./src/likeCount.js");
/* harmony import */ var _likeCount__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_likeCount__WEBPACK_IMPORTED_MODULE_2__);
...
heart.forEach((item)=>item.addEventListener("click",(_likeCount__WEBPACK_IMPORTED_MODULE_2___default())));
